                ...
                <div class="team-line-up col-xs-12 col-md-6">
                    ...
                    <ul class="team-group">
                        ...
                        <li class="player-data">
                            ...
                            <div class="player">
                                <div class="player-name">Max Busberg</div>
                        ...
                        <li class="player-data">
                            ...
                            <div class="player">
                                <div class="player-name">Emil Stiller</div>
                                <div class="player-points"><span class="ttr-points">2000</span></div>   
                            </div>
                        </li>
                        ...
                        <li class="player-data">
                            ...
                            <div class="player">
                                <div class="player-name">Daniel Bitka</div>
                                <div class="player-points"><span class="ttr-points">2000</span></div>   
                            </div>
                        </li>
                        ...
                        <li class="player-data">
                            ...
                            <div class="player">
                                <div class="player-name">Jose Buiza Montero</div>
                                <div class="player-points"><span class="ttr-points">2000</span></div>   
                            </div>
                        </li>
                        ...
                        <li class="player-data">
                            ...
                            <div class="player">
                                <div class="player-name">Niko Mattig</div>
                                <div class="player-points"><span class="ttr-points">2000</span></div>   
                            </div>
                        </li>
                        ...
                        <li class="player-data">
                            ...
                            <div class="player">
                                <div class="player-name">Yasin Ben Ammar</div>
                                <div class="player-points"><span class="ttr-points">2000</span></div>   
                            </div>
                        </li>
